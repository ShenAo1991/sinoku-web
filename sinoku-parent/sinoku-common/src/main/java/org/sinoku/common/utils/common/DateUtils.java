package org.sinoku.common.utils.common;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static String currentTimeByss() {
	 ...
	 * @return
	 */
	public static String getDaysAgoByStr(int n){
		Calendar calendar = Calendar.getInstance();
	 ...
	 * @return
	 */
	public static String getDaysAfterByStr(String date, int n){

		Calendar calendar = Calendar.getInstance();
		calendar.setTime(getDateByStr(date));
		calendar.set(Calendar.DAY_OF_MONTH,calendar.get(Calendar.DAY_OF_MONTH) + n);
